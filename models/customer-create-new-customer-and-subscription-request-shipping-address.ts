 ...
 * @export
 * @interface CustomerCreateNewCustomerAndSubscriptionRequestShippingAddress
 */
export interface CustomerCreateNewCustomerAndSubscriptionRequestShippingAddress {
    /**
     * 
     * @type {string}
     * @memberof CustomerCreateNewCustomerAndSubscriptionRequestShippingAddress
     */
    'addressLine1'?: string;
    /**
     * 
