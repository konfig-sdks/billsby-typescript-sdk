 ...
 * 
 * @export
 * @interface CustomFieldGetResponseResponseInnerCustomField
 */
export interface CustomFieldGetResponseResponseInnerCustomField {
    /**
     * 
     * @type {string}
     * @memberof CustomFieldGetResponseResponseInnerCustomField
     */
    'description'?: string;
    /**
     * 
