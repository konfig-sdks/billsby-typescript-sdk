 ...
 * 
 * @export
 * @interface CustomerCreateNewCustomerAndSubscriptionResponse
 */
export interface CustomerCreateNewCustomerAndSubscriptionResponse {
    /**
     * 
     * @type {string}
     * @memberof CustomerCreateNewCustomerAndSubscriptionResponse
     */
