 ...
 * 
 * @export
 * @interface CustomerAddSubscriptionToExistingCustomerResponse
 */
export interface CustomerAddSubscriptionToExistingCustomerResponse {
    /**
     * 
     * @type {string}
     * @memberof CustomerAddSubscriptionToExistingCustomerResponse
     */
