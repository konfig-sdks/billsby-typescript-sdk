 ...
 * 
 * @export
 * @interface CustomerAddSubscriptionToExistingCustomerRequestCustomFieldResponseInner
 */
export interface CustomerAddSubscriptionToExistingCustomerRequestCustomFieldResponseInner {
    /**
     * The unique ID associated with the customer field in Billsby
     * @type {number}
     * @memberof CustomerAddSubscriptionToExistingCustomerRequestCustomFieldResponseInner
     */
