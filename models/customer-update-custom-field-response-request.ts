 ...
 * 
 * @export
 * @interface CustomerUpdateCustomFieldResponseRequest
 */
export interface CustomerUpdateCustomFieldResponseRequest {
    /**
     * Input the response that you would like to update to
     * @type {string}
     * @memberof CustomerUpdateCustomFieldResponseRequest
     */
    'value': string;
}
