...
import { ProductCreateNewProductResponseProductCountryLimitationCountrySettingsInner } from './product-create-new-product-response-product-country-limitation-country-settings-inner';

/**
 * 
 * @export
 * @interface ProductCreateNewProductResponseProductCountryLimitation
 */
export interface ProductCreateNewProductResponseProductCountryLimitation {
    /**
     * 
     * @type {boolean}
     * @memberof ProductCreateNewProductResponseProductCountryLimitation
     */
    'isAnyCountryAllowed'?: boolean;
    /**
     * 
     * @type {Array<ProductCreateNewProductResponseProductCountryLimitationCountrySettingsInner>}
     * @memberof ProductCreateNewProductResponseProductCountryLimitation
     */
    'countrySettings'?: Array<ProductCreateNewProductResponseProductCountryLimitationCountrySettingsInner>;
}
