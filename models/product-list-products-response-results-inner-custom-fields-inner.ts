 ...
 * 
 * @export
 * @interface ProductListProductsResponseResultsInnerCustomFieldsInner
 */
export interface ProductListProductsResponseResultsInnerCustomFieldsInner {
    /**
     * 
     * @type {string}
     * @memberof ProductListProductsResponseResultsInnerCustomFieldsInner
     */
    'description'?: string;
    /**
     * 
