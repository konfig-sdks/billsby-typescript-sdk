 ...
 * 
 * @export
 * @interface ProductUpdateProductResponseProductCountryLimitationCountrySettingsInner
 */
export interface ProductUpdateProductResponseProductCountryLimitationCountrySettingsInner {
    /**
     * 
     * @type {string}
     * @memberof ProductUpdateProductResponseProductCountryLimitationCountrySettingsInner
     */
    'countryIso3'?: string;
    /**
     * 
