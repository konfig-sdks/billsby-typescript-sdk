 ...
 * 
 * @export
 * @interface CustomerAddSubscriptionToExistingCustomerRequestCouponCodesInner
 */
export interface CustomerAddSubscriptionToExistingCustomerRequestCouponCodesInner {
    /**
     * The unique identifier of the plan in the Billsby platform
     * @type {number}
     * @memberof CustomerAddSubscriptionToExistingCustomerRequestCouponCodesInner
     */
    'planId': number;
    /**
