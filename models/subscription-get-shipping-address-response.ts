 ...
 * 
 * @export
 * @interface SubscriptionGetShippingAddressResponse
 */
export interface SubscriptionGetShippingAddressResponse {
    /**
     * 
     * @type {string}
     * @memberof SubscriptionGetShippingAddressResponse
     */
    'addressLine1'?: string;
    /**
     * 
