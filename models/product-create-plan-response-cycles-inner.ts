...
import { ProductCreatePlanResponseCyclesInnerPricingModel } from './product-create-plan-response-cycles-inner-pricing-model';

/**
 * 
 * @export
 * @interface ProductCreatePlanResponseCyclesInner
 */
export interface ProductCreatePlanResponseCyclesInner {
    /**
     * 
     * @type {number}
     * @memberof ProductCreatePlanResponseCyclesInner
     */
    'cycleId'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {ProductCreatePlanResponseCyclesInnerPricingModel}
     * @memberof ProductCreatePlanResponseCyclesInner
     */
    'pricingModel'?: ProductCreatePlanResponseCyclesInnerPricingModel;
    /**
     * 
     * @type {string}
     * @memberof ProductCreatePlanResponseCyclesInner
