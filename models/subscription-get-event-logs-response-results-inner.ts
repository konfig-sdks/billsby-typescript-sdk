 ...
 * 
 * @export
 * @interface SubscriptionGetEventLogsResponseResultsInner
 */
export interface SubscriptionGetEventLogsResponseResultsInner {
    /**
     * 
     * @type {number}
     * @memberof SubscriptionGetEventLogsResponseResultsInner
     */
