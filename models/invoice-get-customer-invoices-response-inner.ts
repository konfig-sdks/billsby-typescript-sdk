 ...
 * 
 * @export
 * @interface InvoiceGetCustomerInvoicesResponseInner
 */
export interface InvoiceGetCustomerInvoicesResponseInner {
    /**
     * 
     * @type {number}
     * @memberof InvoiceGetCustomerInvoicesResponseInner
     */
    'invoiceId'?: number;
    /**
     * 
