...
import { ProductCreateCycleResponseInnerPricingModel } from './product-create-cycle-response-inner-pricing-model';

/**
 * 
 * @export
 * @interface ProductCreateCycleResponseInner
 */
export interface ProductCreateCycleResponseInner {
    /**
     * 
     * @type {number}
     * @memberof ProductCreateCycleResponseInner
     */
    'cycleId'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {ProductCreateCycleResponseInnerPricingModel}
     * @memberof ProductCreateCycleResponseInner
     */
    'pricingModel'?: ProductCreateCycleResponseInnerPricingModel;
}
