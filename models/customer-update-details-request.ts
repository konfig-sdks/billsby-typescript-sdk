...
import { CustomerUpdateDetailsRequestBillingAddress } from './customer-update-details-request-billing-address';

/**
 * 
 * @export
 * @interface CustomerUpdateDetailsRequest
 */
export interface CustomerUpdateDetailsRequest {
    /**
     * The customers first name
     * @type {string}
     * @memberof CustomerUpdateDetailsRequest
     */
    'firstName': string;
    /**
    ...
    /**
     * 
     * @type {CustomerUpdateDetailsRequestBillingAddress}
     * @memberof CustomerUpdateDetailsRequest
     */
