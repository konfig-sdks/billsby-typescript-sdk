 ...
 * 
 * @export
 * @interface CustomerGetDetailsResponseBillingAddress
 */
export interface CustomerGetDetailsResponseBillingAddress {
    /**
     * 
     * @type {string}
     * @memberof CustomerGetDetailsResponseBillingAddress
     */
    'addressLine1'?: string;
    /**
     * 
