 ...
 * @export
 * @interface CustomerAddSubscriptionToExistingCustomerRequestAddress
 */
export interface CustomerAddSubscriptionToExistingCustomerRequestAddress {
    /**
     * 
     * @type {string}
     * @memberof CustomerAddSubscriptionToExistingCustomerRequestAddress
     */
    'addressLine1'?: string;
    /**
     * 
