 ...
 * 
 * @export
 * @interface CustomerUpdateDetailsRequestBillingAddress
 */
export interface CustomerUpdateDetailsRequestBillingAddress {
    /**
     * 
     * @type {string}
     * @memberof CustomerUpdateDetailsRequestBillingAddress
     */
    'addressLine1'?: string;
    /**
     * 
