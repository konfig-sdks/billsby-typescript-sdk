...
import { ProductGetDetailsResponseProductCountryLimitationCountrySettingsInner } from './product-get-details-response-product-country-limitation-country-settings-inner';

/**
 * 
 * @export
 * @interface ProductGetDetailsResponseProductCountryLimitation
 */
export interface ProductGetDetailsResponseProductCountryLimitation {
    /**
     * 
     * @type {boolean}
     * @memberof ProductGetDetailsResponseProductCountryLimitation
     */
    'isAnyCountryAllowed'?: boolean;
    /**
     * 
     * @type {Array<ProductGetDetailsResponseProductCountryLimitationCountrySettingsInner>}
     * @memberof ProductGetDetailsResponseProductCountryLimitation
     */
    'countrySettings'?: Array<ProductGetDetailsResponseProductCountryLimitationCountrySettingsInner>;
}
