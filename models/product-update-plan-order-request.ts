 ...
 * 
 * @export
 * @interface ProductUpdatePlanOrderRequest
 */
export interface ProductUpdatePlanOrderRequest {
    /**
     * A list of Plan IDs in the desired order to show
     * @type {Array<number>}
     * @memberof ProductUpdatePlanOrderRequest
     */
    'orderedPlanIds'?: Array<number>;
}
