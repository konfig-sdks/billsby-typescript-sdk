...
import { ProductListPlansResponseInnerCyclesInnerPricingModel } from './product-list-plans-response-inner-cycles-inner-pricing-model';

/**
 * 
 * @export
 * @interface ProductListPlansResponseInnerCyclesInner
 */
export interface ProductListPlansResponseInnerCyclesInner {
    /**
     * 
     * @type {number}
     * @memberof ProductListPlansResponseInnerCyclesInner
     */
    'cycleId'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {ProductListPlansResponseInnerCyclesInnerPricingModel}
     * @memberof ProductListPlansResponseInnerCyclesInner
     */
    'pricingModel'?: ProductListPlansResponseInnerCyclesInnerPricingModel;
    /**
     * 
     * @type {string}
     * @memberof ProductListPlansResponseInnerCyclesInner
