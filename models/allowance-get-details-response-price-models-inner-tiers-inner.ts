 ...
 * 
 * @export
 * @interface AllowanceGetDetailsResponsePriceModelsInnerTiersInner
 */
export interface AllowanceGetDetailsResponsePriceModelsInnerTiersInner {
    /**
     * 
     * @type {number}
     * @memberof AllowanceGetDetailsResponsePriceModelsInnerTiersInner
     */
    'finish'?: number;
    /**
     * 
