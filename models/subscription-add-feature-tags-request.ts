 ...
 * 
 * @export
 * @interface SubscriptionAddFeatureTagsRequest
 */
export interface SubscriptionAddFeatureTagsRequest {
    /**
     * Add subscription IDs of all the subscriptions you want to add the feature tags to.
     * @type {Array<string>}
     * @memberof SubscriptionAddFeatureTagsRequest
     */
    'subscriptionUniqueIds'?: Array<string>;
    /**
