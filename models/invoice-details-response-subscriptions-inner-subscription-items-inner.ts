 ...
 * 
 * @export
 * @interface InvoiceDetailsResponseSubscriptionsInnerSubscriptionItemsInner
 */
export interface InvoiceDetailsResponseSubscriptionsInnerSubscriptionItemsInner {
    /**
     * 
     * @type {string}
     * @memberof InvoiceDetailsResponseSubscriptionsInnerSubscriptionItemsInner
     */
    'description'?: string;
    /**
     * 
