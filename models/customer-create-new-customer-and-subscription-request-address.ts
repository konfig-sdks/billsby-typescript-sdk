 ...
 * @export
 * @interface CustomerCreateNewCustomerAndSubscriptionRequestAddress
 */
export interface CustomerCreateNewCustomerAndSubscriptionRequestAddress {
    /**
     * 
     * @type {string}
     * @memberof CustomerCreateNewCustomerAndSubscriptionRequestAddress
     */
    'addressLine1'?: string;
    /**
     * 
