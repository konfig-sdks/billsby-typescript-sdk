...
import { SubscriptionListSubscriptionsResponseResultsInner } from './subscription-list-subscriptions-response-results-inner';

/**
 * 
 * @export
 * @interface SubscriptionListSubscriptionsResponse
 */
export interface SubscriptionListSubscriptionsResponse {
    /**
     * 
     * @type {number}
     * @memberof SubscriptionListSubscriptionsResponse
     */
    'currentPage'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<SubscriptionListSubscriptionsResponseResultsInner>}
     * @memberof SubscriptionListSubscriptionsResponse
     */
    'results'?: Array<SubscriptionListSubscriptionsResponseResultsInner>;
}
