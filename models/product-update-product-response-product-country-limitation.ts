...
import { ProductUpdateProductResponseProductCountryLimitationCountrySettingsInner } from './product-update-product-response-product-country-limitation-country-settings-inner';

/**
 * 
 * @export
 * @interface ProductUpdateProductResponseProductCountryLimitation
 */
export interface ProductUpdateProductResponseProductCountryLimitation {
    /**
     * 
     * @type {boolean}
     * @memberof ProductUpdateProductResponseProductCountryLimitation
     */
    'isAnyCountryAllowed'?: boolean;
    /**
     * 
     * @type {Array<ProductUpdateProductResponseProductCountryLimitationCountrySettingsInner>}
     * @memberof ProductUpdateProductResponseProductCountryLimitation
     */
    'countrySettings'?: Array<ProductUpdateProductResponseProductCountryLimitationCountrySettingsInner>;
}
