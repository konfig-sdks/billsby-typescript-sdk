 ...
 * 
 * @export
 * @interface ProductCreateNewProductResponseProductCountryLimitationCountrySettingsInner
 */
export interface ProductCreateNewProductResponseProductCountryLimitationCountrySettingsInner {
    /**
     * 
     * @type {string}
     * @memberof ProductCreateNewProductResponseProductCountryLimitationCountrySettingsInner
     */
    'countryIso3'?: string;
    /**
     * 
