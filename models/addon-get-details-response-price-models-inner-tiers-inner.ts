 ...
 * 
 * @export
 * @interface AddonGetDetailsResponsePriceModelsInnerTiersInner
 */
export interface AddonGetDetailsResponsePriceModelsInnerTiersInner {
    /**
     * 
     * @type {number}
     * @memberof AddonGetDetailsResponsePriceModelsInnerTiersInner
     */
    'finish'?: number;
    /**
     * 
