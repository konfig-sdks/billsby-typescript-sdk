 ...
 * 
 * @export
 * @interface CustomerUpdateDetailsResponseBillingAddress
 */
export interface CustomerUpdateDetailsResponseBillingAddress {
    /**
     * 
     * @type {string}
     * @memberof CustomerUpdateDetailsResponseBillingAddress
     */
    'addressLine1'?: string;
    /**
     * 
