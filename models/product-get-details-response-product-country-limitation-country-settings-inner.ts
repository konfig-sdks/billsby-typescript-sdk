 ...
 * 
 * @export
 * @interface ProductGetDetailsResponseProductCountryLimitationCountrySettingsInner
 */
export interface ProductGetDetailsResponseProductCountryLimitationCountrySettingsInner {
    /**
     * 
     * @type {string}
     * @memberof ProductGetDetailsResponseProductCountryLimitationCountrySettingsInner
     */
    'countryIso3'?: string;
    /**
     * 
