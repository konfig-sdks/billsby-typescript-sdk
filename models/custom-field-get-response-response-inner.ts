...
import { CustomFieldGetResponseResponseInnerCustomField } from './custom-field-get-response-response-inner-custom-field';

/**
 * 
 * @export
 * @interface CustomFieldGetResponseResponseInner
 */
export interface CustomFieldGetResponseResponseInner {
    /**
     * 
     * @type {number}
     * @memberof CustomFieldGetResponseResponseInner
     */
    'customFieldResponseId'?: number;
    /**
     * 
     * @type {CustomFieldGetResponseResponseInnerCustomField}
     * @memberof CustomFieldGetResponseResponseInner
     */
    'customField'?: CustomFieldGetResponseResponseInnerCustomField;
    /**
     * 
     * @type {string}
     * @memberof CustomFieldGetResponseResponseInner
