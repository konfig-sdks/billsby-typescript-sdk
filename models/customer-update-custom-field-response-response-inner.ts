...
import { CustomerUpdateCustomFieldResponseResponseInnerCustomField } from './customer-update-custom-field-response-response-inner-custom-field';

/**
 * 
 * @export
 * @interface CustomerUpdateCustomFieldResponseResponseInner
 */
export interface CustomerUpdateCustomFieldResponseResponseInner {
    /**
     * 
     * @type {number}
     * @memberof CustomerUpdateCustomFieldResponseResponseInner
     */
    'customFieldResponseId'?: number;
    /**
     * 
     * @type {CustomerUpdateCustomFieldResponseResponseInnerCustomField}
     * @memberof CustomerUpdateCustomFieldResponseResponseInner
     */
    'customField'?: CustomerUpdateCustomFieldResponseResponseInnerCustomField;
    /**
     * 
     * @type {string}
     * @memberof CustomerUpdateCustomFieldResponseResponseInner
