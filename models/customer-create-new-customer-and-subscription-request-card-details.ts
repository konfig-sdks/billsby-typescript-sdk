 ...
 * @export
 * @interface CustomerCreateNewCustomerAndSubscriptionRequestCardDetails
 */
export interface CustomerCreateNewCustomerAndSubscriptionRequestCardDetails {
    /**
     * The full name of the customer
     * @type {string}
     * @memberof CustomerCreateNewCustomerAndSubscriptionRequestCardDetails
     */
    'fullName'?: string;
    /**
