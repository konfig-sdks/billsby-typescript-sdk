 ...
 * Define your tiers
 * @export
 * @interface ProductUpdatePlanAndCycleRequestCyclesTiers
 */
export interface ProductUpdatePlanAndCycleRequestCyclesTiers {
    /**
     * Start unit
     * @type {number}
     * @memberof ProductUpdatePlanAndCycleRequestCyclesTiers
     */
    'start'?: number;
    /**
