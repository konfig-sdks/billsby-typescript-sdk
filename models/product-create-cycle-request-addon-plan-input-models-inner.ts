...
import { ProductCreateCycleRequestAddonPlanInputModelsInnerAddonPriceModelsInner } from './product-create-cycle-request-addon-plan-input-models-inner-addon-price-models-inner';

/**
 * 
 * @export
 * @interface ProductCreateCycleRequestAddonPlanInputModelsInner
 */
export interface ProductCreateCycleRequestAddonPlanInputModelsInner {
    /**
     * 
     * @type {number}
     * @memberof ProductCreateCycleRequestAddonPlanInputModelsInner
     */
    'addonId': number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ProductCreateCycleRequestAddonPlanInputModelsInnerAddonPriceModelsInner>}
     * @memberof ProductCreateCycleRequestAddonPlanInputModelsInner
     */
    'addonPriceModels'?: Array<ProductCreateCycleRequestAddonPlanInputModelsInnerAddonPriceModelsInner>;
}
