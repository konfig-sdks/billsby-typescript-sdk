 ...
 * 
 * @export
 * @interface ProductCreateCycleRequestCyclesInputModelInnerTiersInner
 */
export interface ProductCreateCycleRequestCyclesInputModelInnerTiersInner {
    /**
     * Start unit
     * @type {number}
     * @memberof ProductCreateCycleRequestCyclesInputModelInnerTiersInner
     */
    'start'?: number;
    /**
