...
import { InvoiceDetailsResponseSubscriptionsInnerSubscriptionItemsInner } from './invoice-details-response-subscriptions-inner-subscription-items-inner';

/**
 * 
 * @export
 * @interface InvoiceDetailsResponseSubscriptionsInner
 */
export interface InvoiceDetailsResponseSubscriptionsInner {
    /**
     * 
     * @type {string}
     * @memberof InvoiceDetailsResponseSubscriptionsInner
     */
    ...
    /**
     * 
     * @type {Array<InvoiceDetailsResponseSubscriptionsInnerSubscriptionItemsInner>}
     * @memberof InvoiceDetailsResponseSubscriptionsInner
     */
    'subscriptionItems'?: Array<InvoiceDetailsResponseSubscriptionsInnerSubscriptionItemsInner>;
}
