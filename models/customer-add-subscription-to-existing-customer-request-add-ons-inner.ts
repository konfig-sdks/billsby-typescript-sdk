 ...
 * 
 * @export
 * @interface CustomerAddSubscriptionToExistingCustomerRequestAddOnsInner
 */
export interface CustomerAddSubscriptionToExistingCustomerRequestAddOnsInner {
    /**
     * The unique identifier of the add-ons in the Billsby platform
     * @type {number}
     * @memberof CustomerAddSubscriptionToExistingCustomerRequestAddOnsInner
     */
    'addOnId': number;
    /**
