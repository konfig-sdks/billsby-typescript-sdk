 ...
 * 
 * @export
 * @interface CustomerUpdateCustomFieldResponseResponseInnerCustomField
 */
export interface CustomerUpdateCustomFieldResponseResponseInnerCustomField {
    /**
     * 
     * @type {string}
     * @memberof CustomerUpdateCustomFieldResponseResponseInnerCustomField
     */
    'description'?: string;
    /**
     * 
